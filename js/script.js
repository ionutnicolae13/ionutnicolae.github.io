...
window.addEventListener('scroll', function() {
    ...
    nav.classList.toggle('header__sticky-nav', window.scrollY > 40);
});
...
toggleButton.addEventListener('click', () => {
    ...
    navItem.forEach((link) => {
        if (link.style.animation) {
            ...
            link.style.animation = 'navLinkFade 600ms';
        }
    });
});
...
//     if (direction == "down") {
//         $('nav').addClass('header__sticky-nav');
//     } else {
//         $('nav').removeClass('header__sticky-nav');
//     }
// }, {
//     offset: '6rem;'
// });
...
// $('.js--main-nav-button').click(function() {
